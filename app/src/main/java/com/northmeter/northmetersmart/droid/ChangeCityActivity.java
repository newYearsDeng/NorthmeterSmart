...
public class ChangeCityActivity extends BaseActivity implements OnScrollListener {
		...
		personList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position >= 3) {
					...
					bundle.putString("city_result", allCity_lists.get(position).getName());
					resultIntent.putExtras(bundle);
					ChangeCityActivity.this.setResult(1, resultIntent);
					ChangeCityActivity.this.finish();
					
//					Toast.makeText(getApplicationContext(),
//							"4 "+allCity_lists.get(position).getName(),
//							Toast.LENGTH_SHORT).show();
		...
		resultList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Bundle bundle = new Bundle();
				Intent resultIntent = new Intent();
				bundle.putString("city_result", city_result.get(position).getName());
				resultIntent.putExtras(bundle);
				ChangeCityActivity.this.setResult(1, resultIntent);
				ChangeCityActivity.this.finish();
//				Toast.makeText(getApplicationContext(),
//						"5 "+city_result.get(position).getName(), Toast.LENGTH_SHORT)
//						.show();
			}
		});
		initOverlay();
		...
		findViewById(R.id.but_back_1).setOnClickListener(new OnClickListener() {
			...
			if (viewType == 0) { // 定位
				...
				hotCity.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						Bundle bundle = new Bundle();
						Intent resultIntent = new Intent();
						bundle.putString("city_result", city_hot.get(position).getName());
						resultIntent.putExtras(bundle);
						ChangeCityActivity.this.setResult(1, resultIntent);
						ChangeCityActivity.this.finish();

//						Toast.makeText(getApplicationContext(),
//								"3 "+city_hot.get(position).getName(),
//								Toast.LENGTH_SHORT).show();
