...
import com.northmeter.northmetersmart.fragment.TV_Fragment1;
import com.northmeter.northmetersmart.fragment.TV_Fragment2_2;
...
/** TV */
@SuppressLint("NewApi")
public class TVAty extends FragmentActivity implements OnCheckedChangeListener,
		OnClickListener {
	
	final static String TAG = "TV_LOGCAT";

	// private LinearLayout Linearlayout_val;
	private TV_Fragment1 fragment1;
	private TV_Fragment2_2 fragment2;
	private TV_Fragment5 fragment3;
	private TV_Fragment4 fragment4;
//	private Change_Message fragment5;
...
//----------------------------------------------------------------------------------
	...
	public void onClick(View v) {
		...
		case R.id.put_button:
			Intent intent = new Intent(TVAty.this,Change_Message.class);
    ...
    private void InitViewPager() {
    	try{
	        ...
	        fragment1 = new TV_Fragment1();
			fragment2 = new TV_Fragment2_2();
			fragment3 = new TV_Fragment5(); 
	        ...
	        mPager.setCurrentItem(0);
	        mPager.setOffscreenPageLimit(4);//不预存页面
    	}catch(Exception e){
    		e.printStackTrace();
    	}
    }
        ...
        public void onPageSelected(int arg0) {
        	try{ 
	            ...
	            case 0:
	            	...
	            	new RequestHelp(TVAty.this).get_cq_of_meter(str_mac, str_type);
	            	new RequestHelp(TVAty.this).get_socket_readtime_workflow(str_mac, str_type);
	                break;
	            case 1:
	            	radio_1.setChecked(true);
	            	new RequestHelp(TVAty.this).get_report_year_month_list(handler_1,str_mac,str_type);
	            	//new RequestHelp(getApplicationContext()).get_work_activities(handler_1,str_mac, str_type);
	            	break;
	            case 2:
	            	radio_2.setChecked(true);
	            	//new RequestHelp(TVAty.this).get_Form_Data48h(str_mac,str_type);
	            	new RequestHelp(TVAty.this).get_Form_Data30point_1(handler_1,str_mac,str_type);
	                break;
	            case 3:
				...
				if (msg.what == 1) {
					...
					if(bundle_msg.split("/")[1].equals(str_mac)){
						...
						case "read30point"://selected/(注：前面这些数据不传递过来)     0a0001a820/160127001282/read30point/data
							...
							break;	
						case "get_work_activities"://活动数据 selected/(注：前面这些数据不传递过来)   0a0001aa7k/002014110119/get_work_activities/data
  							try{
  							...
  							break;
  						case "get_report_year_month_list"://报表月份 selected/(注：前面这些数据不传递过来)   0a0001aa7k/002014110119/get_report_year_month_list/data
  							try{
