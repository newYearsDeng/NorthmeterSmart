...
//		str.append(code);
	...
	public static String getGreeFrequency(String zl){
		...
		if(zllist[0].equals("关")){
			...
			String holder="0348027B024802CE0604015423021223010B205002354F0020004000A0399E013923011223010B207002364F0020000080E0";
			return holder;
		}
		...
		hwm.append("49027B024302D40604015423011223");
		//hwm.append("4A0278024802D30604013823021223");
		//hwm.append("480276024D02D30604013A23021223");
		...
		hwm.append("02374F0020");
		//hwm.append("02364F0020");
		//hwm.append("024F4F0020");
		hwm.append(get_two_data(zllist));

		//hwm.append("789F0136246D1123");
		hwm.append("359E013923041223");
		//hwm.append("399E013823011223");
		//hwm.append("3A9E013923001223");
		hwm.append(speedsleep(zllist));
		hwm.append(modelswitch(zllist));
		hwm.append(temp_timing(zllist));
		hwm.append(timing_light(zllist));
