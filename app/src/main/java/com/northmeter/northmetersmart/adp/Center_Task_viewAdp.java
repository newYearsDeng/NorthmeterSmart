...
/** 中央空调定时ListView Adapter */
public class Center_Task_viewAdp extends BaseAdapter {
	...
	public Center_Task_viewAdp(Context context, List<F_Kt_Lv_Model> models) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View view;
		if(viewholder==null){
			 convertView = LayoutInflater.from(context).inflate(R.layout.center_task_viewadp_item, null);
			 ...
			 viewholder.txt_onoff = (TextView) convertView.findViewById(R.id.txt_onoff);
		...
		if(model.getTxt1().equals("01")){
			viewholder.txt_onoff.setText("中央空调打开");
		}else{
			viewholder.txt_onoff.setText("中央空调关闭");
		}
