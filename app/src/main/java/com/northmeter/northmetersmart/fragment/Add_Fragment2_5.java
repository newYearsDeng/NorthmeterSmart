...
/**wifi空调控制器*/
public class Add_Fragment2_5 extends Fragment implements OnClickListener{
		...
		private MySmartconfigTask_2 scTask;
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			test.setText(Html.fromHtml("<b><font color=#1111EE>请按一下设备面板上的配置按钮</font></b> "+ "<font>,插座液晶的电话通讯符号变为快速闪烁，开始进入配置状态</font>"));
...
//		        }.start();
			...
			scTask = new MySmartconfigTask_2(this.getActivity());
	 ...
	 * 
	 */
	class MySmartconfigTask_2 extends AsyncTask<Object, Object, Object> implements
		...
		public MySmartconfigTask_2() {

		}

		public MySmartconfigTask_2(Context context) {
...
//						.setChecked(true); // 成功连接设备，跳转至下一页
				FragmentHelper.loadFragment(FragmentHelper.fragments.get(12));//通过Fragment设置选中
