...
/**服务页面，配置定时任务，其他功能的界面*/
public class Kt_Frag_Center_3  extends Fragment implements OnClickListener{
	private View view;
	private ListView listview;
	private String str_mac,str_type,str_name,roleid;
		...
		try{
			...
			listview.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					case "周循环定时任务":
						Intent intent_1 = new Intent(getActivity(),Kt_Frag_Center_3_view.class);
