...
/**wifi插座*/
public class Add_Fragment4 extends Fragment implements OnClickListener {
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.f_add_4, container, false);
	    ...
	    handler = new Handler() {  
            ...
            public void handleMessage(Message msg) {  
                ...
                if(val.equals("FANHUI")||val.equals(null)){
                	...
                	progressDialog.dismiss();
                    Add_Fragment4.this.biaoHao.append(val);
