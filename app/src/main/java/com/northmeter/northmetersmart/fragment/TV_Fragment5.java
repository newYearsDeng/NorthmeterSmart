...
public class TV_Fragment5 extends Fragment {
	Resources resources;
	...
	private void InitTextView(View parentView) {
	    ...
	    private void InitViewPager(View parentView) {
	        ...
	        tvTabNew.setText("活动");
	        tvTabHot.setText("报表");	        	 
	        //tv_f1 = new Kt_Frag4();//分体空调信息
	        tv_f1 = new TV_Fragment5_1();//活动
	        tv_f2 = new TV_Fragment5_2();//分体空调月报表
	        ...
	        mPager.setOffscreenPageLimit(2);//不预存页面
