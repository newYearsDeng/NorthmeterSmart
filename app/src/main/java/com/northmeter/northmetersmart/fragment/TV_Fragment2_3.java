...
/**四路灯控面板实时功率曲线，30个点*/
public class TV_Fragment2_3 extends Fragment implements OnClickListener,
		OnChartValueSelectedListener , TVAty_Four_street.DataChange {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		try{
			...
			((TVAty_Four_street) getActivity()).setData(this);
									...
									if(!receive.equals("null")){
										...
										for(int i=0; i<rec_list.length; i++ ){
											...
											if(i==rec_list.length-1){
												...
												msg.setData(bundle);
												TV_Fragment2_3.this.handler.sendMessage(msg);
											}
										}
									}
