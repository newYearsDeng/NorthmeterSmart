...
/**无线智能网关*/
public class Add_Fragment2_4 extends Fragment implements OnClickListener{
		...
		private MySmartconfigTask_1 scTask;
...
//		        }.start();
			...
			scTask = new MySmartconfigTask_1(this.getActivity());
	 ...
	 * 
	 */
	class MySmartconfigTask_1 extends AsyncTask<Object, Object, Object> implements
		...
		public MySmartconfigTask_1() {

		}

		public MySmartconfigTask_1(Context context) {
...
//						.setChecked(true); // 成功连接设备，跳转至下一页
				FragmentHelper.loadFragment(FragmentHelper.fragments.get(11));//通过Fragment设置选中
